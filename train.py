...
if __name__ == '__main__':
    ...
    neck_channel = (64, 128, 256, 512)##(24, 40, 112, 960) 
    pa_in_channels = 512
    hidden_dim = 128
    num_classes = 6
    ...
    # create model
    print("Create model......")
    model = PAN(pretrained=True, neck_channel=neck_channel, pa_in_channels=pa_in_channels, hidden_dim=hidden_dim, num_classes=num_classes)
